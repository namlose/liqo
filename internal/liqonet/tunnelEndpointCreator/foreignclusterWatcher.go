...
func (tec *TunnelEndpointCreator) StartForeignClusterWatcher() {
	...
	dynFactory := dynamicinformer.NewDynamicSharedInformerFactory(tec.DynClient, 0)
	go tec.Watcher(dynFactory, discoveryv1alpha1.ForeignClusterGroupResource, cache.ResourceEventHandlerFuncs{
